                  ...
                  {formData.imageUrl ? (
                    ...
                    <div>
                      ...
                      <input
                        ...
                        id="image-upload"
                      />
                      <label htmlFor="image-upload" className="cursor-pointer inline-block mt-2 px-4 py-2 bg-black text-white hover:bg-gray-800 transition-colors text-xs uppercase tracking-widest">
