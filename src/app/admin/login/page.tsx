...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4 transition-colors duration-300 font-serif">
      <div className="bg-white border border-gray-200 p-8 w-full max-w-md transition-colors duration-300">
        {/* Logo */}
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2 font-sans font-light">
        ...
        <form onSubmit={handleLogin} className="space-y-6 font-sans">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 rtl:pl-3 rtl:pr-10 pr-3 py-3 border-b border-gray-300 bg-transparent focus:outline-none focus:border-black text-black transition-colors"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-black text-white py-4 px-4 text-sm uppercase tracking-widest hover:bg-gray-800 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
