...
export default function EditBookForm({ book, onClose, onSave }: EditBookFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    try {
      adminDataService.updateBook(book.id, updatedBook);
