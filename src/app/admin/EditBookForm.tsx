                ...
                >
                  {formData.imageUrl ? (
                    ...
                    <div>
                      ...
                      />
                      <label htmlFor="edit-image-upload" className="cursor-pointer inline-block mt-2 px-4 py-2 bg-[#2c2c2c] dark:bg-white text-white dark:text-black hover:bg-black dark:hover:bg-gray-200 transition-colors text-xs uppercase tracking-widest">
