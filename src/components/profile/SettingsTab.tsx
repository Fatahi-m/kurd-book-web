  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <h2 className="text-xl font-semibold text-gray-900">ڕێکخستنەکان</h2>
        {updateMessage && (
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        <h3 className="text-lg font-medium text-gray-900 mb-4">زمان و نیشاندان</h3>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        <h3 className="text-lg font-medium text-gray-900 mb-4">ئاگادارکردنەوەکان</h3>
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <label className="text-sm font-medium text-gray-700">ئاگادارکردنەوەی ئیمەیل</label>
              <p className="text-xs text-gray-500">وەرگرتنی ئاگادارکردنەوە بە ئیمەیل</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <label className="text-sm font-medium text-gray-700">پەیامی کورت (SMS)</label>
              <p className="text-xs text-gray-500">وەرگرتنی پەیامی کورت</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
          ...
          <div className="flex items-center justify-between">
            <div>
              <label className="text-sm font-medium text-gray-700">نوێکردنەوەی داواکاری</label>
              <p className="text-xs text-gray-500">ئاگادارکردنەوە دەربارەی باری داواکارییەکان</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
          ...
          <div className="flex items-center justify-between">
            <div>
              <label className="text-sm font-medium text-gray-700">کتابە نوێکان</label>
              <p className="text-xs text-gray-500">ئاگادارکردنەوە دەربارەی کتابە نوێکان</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
          ...
          <div className="flex items-center justify-between">
            <div>
              <label className="text-sm font-medium text-gray-700">پڕۆموشنەکان</label>
              <p className="text-xs text-gray-500">ئاگادارکردنەوە دەربارەی داشکاندن و پیشکەشکراوەکان</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
      ...
      {/* Privacy Settings */}
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        <h3 className="text-lg font-medium text-gray-900 mb-4">تایبەتمەندی</h3>
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <label className="text-sm font-medium text-gray-700">پڕۆفایلی گشتی</label>
              <p className="text-xs text-gray-500">ڕێگەدان بە کەسانی تر بۆ بینینی پڕۆفایلت</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
          ...
          <div className="flex items-center justify-between">
            <div>
              <label className="text-sm font-medium text-gray-700">پیشانداری مێژووی کڕین</label>
              <p className="text-xs text-gray-500">نیشاندانی کتابە کڕراوەکان لە پڕۆفایلدا</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
          ...
          <div className="flex items-center justify-between">
            <div>
              <label className="text-sm font-medium text-gray-700">پێشنیاری کتاب</label>
              <p className="text-xs text-gray-500">ڕێگەدان بە پێشنیاری کتاب بەپێی ئارەزووەکانت</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
